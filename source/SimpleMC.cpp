...
void SimpleMC(double spot, const Parameter& r, const Parameter& vol, const VanillaOption& vanilla_option, 
	...
	double moved_spot = spot*exp(r.Integral(0,expiry)-0.5*variance);
